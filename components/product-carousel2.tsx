  ...
  const renderProductCard = (product: any) => (
    <div key={product.id} className="relative group w-full">
      <Link href={`/produto/${product.slug}`} className="block">
        <div className="bg-gray-50 rounded-lg overflow-hidden h-[380px]">
    ...
    <section className="py-12 bg-white">
      <div className="max-w-5xl mx-auto px-4">
        <div className="text-center mb-8">
          <h2 className="text-2xl md:text-3xl font-medium text-rose-400">Nossos lançamentos</h2>
          <p className="text-lg mt-2">Confira todas as novidades do BB4U</p>
        </div>
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                margin: "0 -10px", // Negative margin para criar o efeito de corte
                width: "calc(100% + 20px)", // Compensar as margens negativas
              }}
            >
              {products.map((product, index) => (
                <div
                  ...
                  style={{
                    width: isMobile ? "100%" : `${100 / 4.5}%`, // 4.5 em vez de 4 para mostrar parte do próximo produto
                    transition: "transform 0.5s cubic-bezier(0.25, 0.1, 0.25, 1), opacity 0.5s ease",
